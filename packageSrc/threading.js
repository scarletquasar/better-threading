...
var Thread = exports.Thread = /*#__PURE__*/function () {
  function Thread(target) {
    var _this = this;
    var sharedObject = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    ...
    var sharedFinal = {};
    Object.entries(sharedObject !== null && sharedObject !== void 0 ? sharedObject : {}).forEach(function (entry) {
      sharedFinal[entry[0]] = entry[1];
    });
    var assembledClosure = function assembledClosure(target, shared, imports, features) {
      ...
      var threadStartPerformanceTime = performance.now();
      var threadRelativeStart = new Date();
      ...
      Object.entries(imports).forEach(function (importEntry) {
        globalThis["better-threading"].imports[importEntry[0]] = {};
        importEntry[1].forEach(function (value) {
      ...
      var threadEndPerformanceTime = performance.now();
      var threadRelativeEnd = new Date();
    ...
    var textScript = "\n            (".concat(assembledClosure.toString(), ")\n            (\n                ").concat(target.toString(), ", \n                ").concat(JSON.stringify(sharedFinal), ", \n                ").concat(JSON.stringify(imports), ", \n                {\n                    sleep: ").concat(sleep.toString(), "\n                }\n            );");
    this.execute = function () {
      _this.promise = new Promise(function (resolve, reject) {
        _this.worker = new _nodeWorker_threads.Worker(textScript, {
          eval: true
        });
        _this.worker.on('error', function (err) {
          reject(err);
        });
        _this.worker.on('message', function (data) {
  ...
  _createClass(Thread, [{
    key: "then",
    value: // Promise-like implementation
    function () {
      var _then = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(onfulfilled, onrejected) {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", this.execute().then(onfulfilled, onrejected));
            case 1:
            case "end":
...
_defineProperty(Thread, "sleep", function (delay) {
